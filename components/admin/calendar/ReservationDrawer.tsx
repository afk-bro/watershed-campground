    ...
    <>
      ...
      >
        <div className="h-full flex flex-col">
          {/* Header */}
          <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-brand-forest text-white">
            <div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-slate-900">Party Size</div>
                    <div className="text-slate-600">
            ...
            <div className="pt-6 border-t mt-auto">
              <Link
                ...
                className="block w-full text-center bg-slate-900 text-white py-3 rounded-lg font-medium hover:bg-slate-800 transition-colors"
              >
                Full Edit Details
              </Link>
            </div>
